  ...
  useEffect(() => {
    const fetchMetrics = async () => {
      ...
      try {
        ...
        // Example:
        // const { data: appointmentsData } = await supabase.rpc('get_weekly_appointments', { doctor_id: user.id });
        // const { data: patientsData } = await supabase.rpc('get_monthly_patients', { doctor_id: user.id });
        // etc.
